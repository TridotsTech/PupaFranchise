...
# Test suite for pupa_franchise.pupa_franchise.report.supplier_ledger
# Tests Supplier Ledger report columns, data, balances, and address helpers

import frappe
from frappe.tests.utils import FrappeTestCase


class TestSupplierLedgerReport(FrappeTestCase):
    """Tests for the Supplier Ledger report."""

    def test_get_columns_returns_correct_fields(self):
        """get_columns should return the expected column definitions."""
        from pupa_franchise.pupa_franchise.report.supplier_ledger.supplier_ledger import get_columns
        ...
        self.assertIn("supplier", fieldnames)
    ...
    def test_get_columns_correct_fieldtypes(self):
        ...
        self.assertEqual(type_map["supplier"], "Link")
    ...
    def test_date_validation_from_after_to(self):
        ...
        from pupa_franchise.pupa_franchise.report.supplier_ledger.supplier_ledger import execute
    ...
    def test_get_data_with_company_filter(self):
        ...
        from pupa_franchise.pupa_franchise.report.supplier_ledger.supplier_ledger import get_data
    ...
    def test_get_data_with_supplier_filter(self):
        """get_data with supplier filter should use party link logic."""
        from pupa_franchise.pupa_franchise.report.supplier_ledger.supplier_ledger import get_data

        company = frappe.db.get_value("Company", {}, "name")
        supplier = frappe.db.get_value("Supplier", {}, "name")
        if not company or not supplier:
            self.skipTest("No company or supplier found")
    ...
    def test_fetch_opening_balance_returns_tuple(self):
        ...
        from pupa_franchise.pupa_franchise.report.supplier_ledger.supplier_ledger import fetch_opening_balance
    ...
    def test_fetch_closing_balance_returns_number(self):
        ...
        from pupa_franchise.pupa_franchise.report.supplier_ledger.supplier_ledger import fetch_closing_balance
    ...
    def test_fetch_current_total_returns_tuple(self):
        ...
        from pupa_franchise.pupa_franchise.report.supplier_ledger.supplier_ledger import fetch_current_total
...
class TestSupplierLedgerAddressHelpers(FrappeTestCase):
    """Tests for address helper functions in supplier_ledger."""

    def test_company_address_returns_none_for_no_company(self):
        """company_address(None) should return None."""
        from pupa_franchise.pupa_franchise.report.supplier_ledger.supplier_ledger import company_address
    ...
    def test_party_address_returns_none_for_no_party(self):
        ...
        from pupa_franchise.pupa_franchise.report.supplier_ledger.supplier_ledger import party_address

        result = party_address(None)
        self.assertIsNone(result)

    def test_party_address_returns_data_or_empty(self):
        """party_address for supplier should return address tuple or empty string."""
        from pupa_franchise.pupa_franchise.report.supplier_ledger.supplier_ledger import party_address

        supplier = frappe.db.get_value("Supplier", {}, "name")
        if not supplier:
            self.skipTest("No supplier found")

        result = party_address(supplier, party_type="Supplier")
        self.assertTrue(
    ...
    def test_party_address_no_party_type_returns_none(self):
        ...
        result = party_address("Test Supplier", party_type=None)
        self.assertIsNone(result)
